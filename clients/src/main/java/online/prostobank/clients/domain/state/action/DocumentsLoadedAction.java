...
/**
 * Инициируется выполнение при загрузке хотя бы одного файла в раздел документов карточки клиента
 */
@Slf4j
@Component
public class DocumentsLoadedAction implements Action<ClientStates, ClientEvents> {
    @Override
